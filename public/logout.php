...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if(sendSessionLoggedOut($user_name, $login_time)) {
        // イベント送信成功時に表示するメッセージ
        $_SESSION['message'] = 'SessionEvent(Logged Out) was sent successfully.';
    } else {
        // イベント送信失敗時に表示するメッセージ
        $_SESSION['message'] = 'Failed to send SessionEvent(Logged Out).';
    }
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                <div class="card  card-block">
                    ...
                    <p class="text-center">Welcome <b><?php echo $_SESSION['user_name']; ?></b>!</p>
